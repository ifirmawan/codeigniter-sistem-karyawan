  ...
  <div class="row"> 
   ...
   <ol class="breadcrumb">
      ...
      <a class="">1-12/12</a>
                ...
                <a href="<?php echo site_url('contacts'); ?>" class="jvm-btn jvm-btn-default"><i class="fa fa-th"></i></a>
                <a href="<?php echo site_url('contacts/list_tabel'); ?>" class="jvm-btn jvm-btn-default"><i class="fa fa-list"></i></a>
     </div>

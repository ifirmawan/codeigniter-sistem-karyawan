...
<a href="<?php echo site_url('Hrd/ubah_pengalaman_kerja');?>" class="btn btn-default" aria-haspopup="true">
  <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Ubah 
</a>
<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Kembali</button>
</div>
...
<div class="container">
  ...
  <div class="media-body">
    <h2 class="media-heading">Iwan</h2>
    <h3>Operator Komputer</h3>
    <h3>I.Firmawan@jagokomputer.com</h3>
    <h3>25 Th</h3>
  </div>
</div>
...
<div class="container">
  ...
  <li role="presentation"><a href="<?php echo site_url('Hrd/detail_pegawai'); ?>">Identitas</a></li>
  <li role="presentation"><a href="<?php echo site_url('Hrd/detail_pegawai2'); ?>">Riwayat Pendidikan</a></li>
  <li role="presentation" class="active"><a href="<?php echo site_url('Hrd/detail_pegawai3'); ?>">Pengalaman Kerja</a></li>
  </ul>
    </tr>
  </table>
</div>
...
<div class="container">
<textarea cols="144" rows="10" readonly="">
    2014-Sekarang
    Programmer di CV. Java Multi Mandiri Purwokerto

...
<a href="<?php echo site_url('Hrd/ubah_riwayat_pendidikan');?>" class="btn btn-default" aria-haspopup="true">
...
<div class="container">
  ...
  <li role="presentation" class="active"><a href="<?php echo site_url('Hrd/detail_pegawai2'); ?>">Riwayat Pendidikan</a></li>
  <li role="presentation"><a href="<?php echo site_url('Hrd/detail_pegawai3'); ?>">Pengalaman Kerja</a></li>
  </ul>
    </tr>
  </table>
</div>

  ...
  <div align="right">
    <div class="media">
      <div class="media-left">
        <a href="#">
          <img class="media-object" src="<?php echo base_url('assets/img/images.png');?>" height="100" width="100">
        </a>
      </div>
    </div>
  </div>
...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#privacy" role="tab" aria-controls="privacy">PRIVACY</a>
  </li>
  <li class="nav-item">
    <a class="nav-link active" data-toggle="tab" href="#members" role="tab" aria-controls="members">MEMBERS</a>
  </li>
</ul>

	...
	$.fn.extend({
		monthly: function(options) {
			...
			var options = $.extend(defaults, options),
				...
				monthNames = options.monthNames || ["Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember"],
				dayNames = options.dayNames || ['MINGGU','SENIN','SELASA','RABU','KAMIS','JUMAT','SABTU'];
